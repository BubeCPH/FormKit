...
abstract class BaseRegistration extends BaseObject implements Persistent
{
     ...
     * Note: this column has a database default value of: 'CLOSED'
     * @var        string
     */
    protected $state;
    ...
    /**
     * The value for the updated_by_user_id field.
     * @var        int
     */
    ...
    /**
     * Initializes internal state of BaseRegistration object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [updated_by_user_id] column value.
     *
     * @return int
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = RegistrationPeer::USER_ID;
        }
    ...
    public function setActivityId($v)
    {
        ...
        if ($this->activity_id !== $v) {
            $this->activity_id = $v;
            $this->modifiedColumns[] = RegistrationPeer::ACTIVITY_ID;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::START_DATE;
            }
    ...
    public function setStartTime($v)
    {
        ...
        if ($this->start_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::START_TIME;
            }
        } // if either are not null
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::END_DATE;
            }
        } // if either are not null
    ...
    public function setEndTime($v)
    {
        ...
        if ($this->end_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::END_TIME;
            }
        } // if either are not null
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = RegistrationPeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedByUserId($v)
    {
        ...
        if ($this->created_by_user_id !== $v) {
            ...
            $this->modifiedColumns[] = RegistrationPeer::CREATED_BY_USER_ID;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RegistrationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [updated_by_user_id] column.
     *
     * @param  int $v new value
     * @return Registration The current object (for fluent API support)
     */
    public function setUpdatedByUserId($v)
    {
        ...
        if ($this->updated_by_user_id !== $v) {
            $this->updated_by_user_id = $v;
            $this->modifiedColumns[] = RegistrationPeer::UPDATED_BY_USER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->start_time = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            $this->created_by_user_id = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            $this->updated_at = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->updated_by_user_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
            $this->resetModified();
            ...
            return $startcol + 13; // 13 = RegistrationPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RegistrationQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegistrationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RegistrationPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(RegistrationPeer::ACTIVITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`activity_id`';
        }
        if ($this->isColumnModified(RegistrationPeer::STATE)) {
            $modifiedColumns[':p' . $index++]  = '`state`';
        }
        if ($this->isColumnModified(RegistrationPeer::START_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`start_date`';
        }
        if ($this->isColumnModified(RegistrationPeer::START_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`start_time`';
        }
        if ($this->isColumnModified(RegistrationPeer::END_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`end_date`';
        }
        if ($this->isColumnModified(RegistrationPeer::END_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`end_time`';
        }
        if ($this->isColumnModified(RegistrationPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(RegistrationPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(RegistrationPeer::CREATED_BY_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`created_by_user_id`';
        }
        if ($this->isColumnModified(RegistrationPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }
        if ($this->isColumnModified(RegistrationPeer::UPDATED_BY_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`updated_by_user_id`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`updated_by_user_id`':
                        $stmt->bindValue($identifier, $this->updated_by_user_id, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        if (isset($alreadyDumpedObjects['Registration'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Registration'][$this->getPrimaryKey()] = true;
        ...
        $result = array(
            ...
            $keys[10] => $this->getCreatedByUserId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) $this->setCreatedByUserId($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setUpdatedAt($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setUpdatedByUserId($arr[$keys[12]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegistrationPeer::USER_ID)) $criteria->add(RegistrationPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(RegistrationPeer::ACTIVITY_ID)) $criteria->add(RegistrationPeer::ACTIVITY_ID, $this->activity_id);
        if ($this->isColumnModified(RegistrationPeer::STATE)) $criteria->add(RegistrationPeer::STATE, $this->state);
        if ($this->isColumnModified(RegistrationPeer::START_DATE)) $criteria->add(RegistrationPeer::START_DATE, $this->start_date);
        if ($this->isColumnModified(RegistrationPeer::START_TIME)) $criteria->add(RegistrationPeer::START_TIME, $this->start_time);
        if ($this->isColumnModified(RegistrationPeer::END_DATE)) $criteria->add(RegistrationPeer::END_DATE, $this->end_date);
        if ($this->isColumnModified(RegistrationPeer::END_TIME)) $criteria->add(RegistrationPeer::END_TIME, $this->end_time);
        if ($this->isColumnModified(RegistrationPeer::DESCRIPTION)) $criteria->add(RegistrationPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(RegistrationPeer::CREATED_AT)) $criteria->add(RegistrationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(RegistrationPeer::CREATED_BY_USER_ID)) $criteria->add(RegistrationPeer::CREATED_BY_USER_ID, $this->created_by_user_id);
        if ($this->isColumnModified(RegistrationPeer::UPDATED_AT)) $criteria->add(RegistrationPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(RegistrationPeer::UPDATED_BY_USER_ID)) $criteria->add(RegistrationPeer::UPDATED_BY_USER_ID, $this->updated_by_user_id);
     ...
     * @throws PropelException
     */
    public function getActivity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aActivity === null && ($this->activity_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aActivity->addRegistrations($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aActivity instanceof Persistent) {
              $this->aActivity->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(RegistrationPeer::DEFAULT_STRING_FORMAT);
    }
