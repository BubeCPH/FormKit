...
abstract class BaseSetting extends BaseObject implements Persistent
{
    ...
    public function setLongDescription($v)
    {
        ...
        if ($this->long_description !== $v) {
            ...
            $this->modifiedColumns[] = SettingPeer::LONG_DESCRIPTION;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = SettingPeer::TYPE;
        }
    ...
    public function setDefaultValue($v)
    {
        ...
        if ($this->default_value !== $v) {
            ...
            $this->modifiedColumns[] = SettingPeer::DEFAULT_VALUE;
        }
    ...
    public function setFormula($v)
    {
        ...
        if ($this->formula !== $v) {
            $this->formula = $v;
            $this->modifiedColumns[] = SettingPeer::FORMULA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->long_description = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 7; // 7 = SettingPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SettingPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(SettingPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(SettingPeer::LONG_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`long_description`';
        }
        if ($this->isColumnModified(SettingPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(SettingPeer::DEFAULT_VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`default_value`';
        }
        if ($this->isColumnModified(SettingPeer::FORMULA)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getLongDescription(),
            $keys[4] => $this->getType(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setLongDescription($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingPeer::LONG_DESCRIPTION)) $criteria->add(SettingPeer::LONG_DESCRIPTION, $this->long_description);
        if ($this->isColumnModified(SettingPeer::TYPE)) $criteria->add(SettingPeer::TYPE, $this->type);
        if ($this->isColumnModified(SettingPeer::DEFAULT_VALUE)) $criteria->add(SettingPeer::DEFAULT_VALUE, $this->default_value);
        if ($this->isColumnModified(SettingPeer::FORMULA)) $criteria->add(SettingPeer::FORMULA, $this->formula);
