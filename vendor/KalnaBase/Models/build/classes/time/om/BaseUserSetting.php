...
abstract class BaseUserSetting extends BaseObject implements Persistent
{
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[] = UserSettingPeer::UID;
        }
    ...
    public function setPrmId($v)
    {
        ...
        if ($this->prm_id !== $v) {
            $this->prm_id = $v;
            $this->modifiedColumns[] = UserSettingPeer::PRM_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->prm_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = UserSettingPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserSettingQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserSettingPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UserSettingPeer::UID)) {
            $modifiedColumns[':p' . $index++]  = '`uid`';
        }
        if ($this->isColumnModified(UserSettingPeer::PRM_ID)) {
            $modifiedColumns[':p' . $index++]  = '`prm_id`';
        }
        if ($this->isColumnModified(UserSettingPeer::VALUE)) {
    ...
    {
        if (isset($alreadyDumpedObjects['UserSetting'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserSetting'][$this->getPrimaryKey()] = true;
        $keys = UserSettingPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUid(),
            $keys[2] => $this->getPrmId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPrmId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserSettingPeer::UID)) $criteria->add(UserSettingPeer::UID, $this->uid);
        if ($this->isColumnModified(UserSettingPeer::PRM_ID)) $criteria->add(UserSettingPeer::PRM_ID, $this->prm_id);
    ...
    {
        return (string) $this->exportTo(UserSettingPeer::DEFAULT_STRING_FORMAT);
    }
