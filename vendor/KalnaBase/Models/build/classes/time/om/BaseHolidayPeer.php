...
/**
 * Base static class for performing query and update operations on the 'holidays' table.
 *
 *
 *
...
abstract class BaseHolidayPeer
{
    ...
    /** the column name for the dato field */
    const DATO = 'holidays.dato';

    /** the column name for the navn field */
    const NAVN = 'holidays.navn';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Holiday objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Dato', 'Navn', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('dato', 'navn', ),
        BasePeer::TYPE_COLNAME => array (HolidayPeer::DATO, HolidayPeer::NAVN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DATO', 'NAVN', ),
        BasePeer::TYPE_FIELDNAME => array ('dato', 'navn', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Dato' => 0, 'Navn' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('dato' => 0, 'navn' => 1, ),
        BasePeer::TYPE_COLNAME => array (HolidayPeer::DATO => 0, HolidayPeer::NAVN => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DATO' => 0, 'NAVN' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('dato' => 0, 'navn' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(HolidayPeer::DATO);
            $criteria->addSelectColumn(HolidayPeer::NAVN);
        } else {
            $criteria->addSelectColumn($alias . '.dato');
            $criteria->addSelectColumn($alias . '.navn');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to holidays
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(HolidayPeer::DATO);
            $value = $criteria->remove(HolidayPeer::DATO);
            if ($value) {
                $selectCriteria->add(HolidayPeer::DATO, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(HolidayPeer::DATO, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(HolidayPeer::DATABASE_NAME);
        $criteria->add(HolidayPeer::DATO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(HolidayPeer::DATABASE_NAME);
            $criteria->add(HolidayPeer::DATO, $pks, Criteria::IN);
