...
abstract class BaseUserPeer
{
    ...
    /** the column name for the ivery field */
    const IVERY = 'users.ivery';
    ...
    const LAST_LOGIN_AT = 'users.last_login_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Name', 'Ivery', 'CreatedAt', 'UpdatedAt', 'LastLoginAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'name', 'ivery', 'createdAt', 'updatedAt', 'lastLoginAt', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::PASSWORD, UserPeer::NAME, UserPeer::IVERY, UserPeer::CREATED_AT, UserPeer::UPDATED_AT, UserPeer::LAST_LOGIN_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'NAME', 'IVERY', 'CREATED_AT', 'UPDATED_AT', 'LAST_LOGIN_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'name', 'ivery', 'created_at', 'updated_at', 'last_login_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Name' => 3, 'Ivery' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, 'LastLoginAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'name' => 3, 'ivery' => 4, 'createdAt' => 5, 'updatedAt' => 6, 'lastLoginAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::PASSWORD => 2, UserPeer::NAME => 3, UserPeer::IVERY => 4, UserPeer::CREATED_AT => 5, UserPeer::UPDATED_AT => 6, UserPeer::LAST_LOGIN_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'NAME' => 3, 'IVERY' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, 'LAST_LOGIN_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'name' => 3, 'ivery' => 4, 'created_at' => 5, 'updated_at' => 6, 'last_login_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::IVERY);
            ...
            $criteria->addSelectColumn($alias . '.ivery');
